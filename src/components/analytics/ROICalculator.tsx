...
export default function ROICalculator() {
  ...
  const calculateROI = () => {
    ...
    const breakEvenWinRate =
      totalInvestment > 0 ? (totalInvestment / totalWinnings) * 100 : 0;
          ...
          <div className="border-t pt-6">
            ...
            <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                ...
                {result.roi < -20 && (
                  <p>
                    🚨 Значительный убыток. Рекомендуется серьезный анализ игры.
                  </p>
                )}
                <p>
                  💰 Средний результат на турнир:{" "}
                  {formatCurrency(result.profit / tournaments)}
                </p>
                <p>
                  🎯 Для безубыточности нужно выигрывать минимум{" "}
                  {formatCurrency(result.totalInvestment)}
                </p>
              </div>
            </div>
