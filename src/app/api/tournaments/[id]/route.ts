  ...
  try {
    ...
    if (body.result) {
      ...
      const finalResultData = {
        ...
        rebuy_count: resultData.rebuyCount ? parseInt(resultData.rebuyCount) : 0,
        addon_count: resultData.addonCount ? parseInt(resultData.addonCount) : 0,
    ...
    if (Object.keys(tournamentUpdates).length > 0) {
      ...
      if (tournamentUpdates.tournamentType !== undefined) {updateData.tournament_type = tournamentUpdates.tournamentType}
      ...
      if (tournamentUpdates.prizePool !== undefined) {updateData.prize_pool = tournamentUpdates.prizePool ? parseFloat(tournamentUpdates.prizePool) : null}
      if (tournamentUpdates.blindLevels !== undefined) {updateData.blind_levels = tournamentUpdates.blindLevels}
      if (tournamentUpdates.startingStack !== undefined) {updateData.starting_stack = tournamentUpdates.startingStack ? parseInt(tournamentUpdates.startingStack) : null}
      if (tournamentUpdates.ticketImageUrl !== undefined) {updateData.ticket_image_url = tournamentUpdates.ticketImageUrl}
