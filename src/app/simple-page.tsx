    ...
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <span className="ml-2 text-green-600 font-semibold">✅ Работает</span>
            </div>
            <div>
              <span className="text-gray-600">Telegram Bot:</span>
              <span className="ml-2 text-blue-600 font-semibold">🔄 Polling режим</span>
            </div>
            <div>
              <span className="text-gray-600">База данных:</span>
              <span className="ml-2 text-yellow-600 font-semibold">📝 Мок данные</span>
            </div>
            <div>
              <span className="text-gray-600">OCR:</span>
              <span className="ml-2 text-green-600 font-semibold">✅ Готов</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h2 className="text-xl font-semibold mb-4 text-blue-900">📋 Быстрый старт</h2>
