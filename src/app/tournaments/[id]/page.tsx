              ...
              <div className="bg-white rounded-lg shadow p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span
                      className={`font-medium ${tournament.result.payout > 0 ? "text-green-600" : "text-gray-500"}`}
                    >
                      {tournament.result.payout > 0
                        ? formatCurrency(tournament.result.payout)
                        : "Без призов"}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span
                      className={`font-medium ${tournament.result.profit >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
                      {tournament.result.profit >= 0 ? "+" : ""}
                      {formatCurrency(tournament.result.profit)}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between py-2 border-b border-gray-100">
                    ...
                    <span
                      className={`font-medium ${tournament.result.roi >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
