      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          ...
          <ol className="space-y-2 text-blue-800 dark:text-blue-200 text-sm">
            <li>1. Откройте Telegram и найдите бота <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">@BotFather</code></li>
            <li>2. Отправьте команду <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">/newbot</code></li>
            <li>3. Следуйте инструкциям для создания нового бота</li>
            <li>4. Скопируйте полученный токен (формат: <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">123456789:ABCdefGhiJklmNoPQRsTuVwXyZ</code>)</li>
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-900 dark:text-white font-mono">Polling (Long Polling)</span>
            </div>
            <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-gray-400">Библиотека:</span>
              <span className="text-green-600 dark:text-green-400">Telegraf ✅</span>
            </div>
          </div>
