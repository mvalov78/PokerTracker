...
describe('Telegram API Tests', () => {
  ...
  describe('/api/telegram/generate-code', () => {
    test('should generate linking code successfully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/telegram/generate-code', {
        method: 'POST',
  ...
  describe('/api/telegram/status', () => {
    test('should return linking status', async () => {
      ...
      const url = new URL('http://localhost:3000/api/telegram/status?userId=test-user-id')
  ...
  describe('/api/telegram/link', () => {
    test('should link accounts successfully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/telegram/link', {
        method: 'POST',
        body: JSON.stringify({
  ...
  describe('/api/telegram/unlink', () => {
    test('should unlink account successfully', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/telegram/unlink', {
        method: 'POST',
        body: JSON.stringify({ userId: 'test-user-id' })
      })
