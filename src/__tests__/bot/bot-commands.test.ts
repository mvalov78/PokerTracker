...
describe('Bot Commands Tests', () => {
  ...
  describe('help command', () => {
    ...
    test('should handle markdown errors gracefully', async () => {
      ...
      ;(mockCtx.reply as jest.Mock).mockRejectedValueOnce(new Error('Markdown error'))
  ...
  describe('venue management', () => {
    test('should show current venue', async () => {
      ;(UserSettingsService.getCurrentVenue as jest.Mock).mockResolvedValue('PokerStars Live')
    ...
    test('should handle no venue set', async () => {
      ;(UserSettingsService.getCurrentVenue as jest.Mock).mockResolvedValue(null)
    ...
    test('should set venue successfully', async () => {
      ...
      expect(UserSettingsService.updateCurrentVenue).toHaveBeenCalledWith('123456789', 'PokerStars Live')
      expect(mockCtx.reply).toHaveBeenCalledWith(
  ...
  describe('tournament management', () => {
    ...
    test('should handle no tournaments', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith('📝 У вас пока нет зарегистрированных турниров.')
    })
  })
  ...
  describe('statistics', () => {
    ...
    test('should handle no tournaments for stats', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith('📊 У вас пока нет турниров для статистики.')
    })
  })
})
