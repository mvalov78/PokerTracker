...
describe('Utils', () => {
  ...
  describe('getPositionColor', () => {
    ...
    it('should return green for ITM positions', () => {
      expect(getPositionColor(5)).toBe('text-emerald-600 dark:text-emerald-400')
      expect(getPositionColor(10)).toBe('text-emerald-600 dark:text-emerald-400')
    })
  ...
  describe('filterTournamentsByDateRange', () => {
    ...
    it('should filter by end date', () => {
      const filtered = filterTournamentsByDateRange(tournaments, undefined, '2024-01-20')
      expect(filtered).toHaveLength(2)
    ...
    it('should filter by date range', () => {
      const filtered = filterTournamentsByDateRange(tournaments, '2024-01-10', '2024-01-20')
