...
export const createServerComponentClient = jest.fn(() => createClientComponentClient())

export const createAdminClient = jest.fn(() => createClientComponentClient())

// Мок для helper функций
export const getProfile = jest.fn(() => Promise.resolve({
  id: 'mock-user-id',
  username: 'testuser',
  role: 'player',
  telegram_id: null
...
export const createProfile = jest.fn(() => Promise.resolve({
  id: 'mock-user-id',
  username: 'testuser',
  role: 'player',
  telegram_id: null
...
export const getUserOrCreate = jest.fn(() => Promise.resolve({
  id: 'mock-user-id',
  username: 'testuser',
  role: 'player',
