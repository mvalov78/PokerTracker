...
describe("TournamentService", () => {
  ...
  describe("getTournamentsByUserId", () => {
    ...
    it("should handle database errors", async () => {
      ...
      await expect(
        TournamentService.getTournamentsByUserId("user123"),
  ...
  describe("deleteTournament", () => {
    ...
    it("should handle deletion errors", async () => {
      ...
      await expect(TournamentService.deleteTournament("1")).rejects.toThrow(
        "Failed to delete tournament: Deletion failed",
      );
    });
  });
});
