...
describe("BotSettingsService", () => {
  ...
  describe("updateSetting", () => {
    it("should update string setting", async () => {
      ...
      const result = await BotSettingsService.updateSetting(
        "webhook_url",
        "https://new.com",
      );
  ...
  describe("incrementErrorCount", () => {
    ...
    it("should handle errors gracefully", async () => {
      ...
      await expect(
        BotSettingsService.incrementErrorCount(),
  ...
  describe("getWebhookUrl", () => {
    it("should return webhook URL", async () => {
      const mockSetting = createMockBotSetting(
        "webhook_url",
  ...
  describe("setWebhookUrl", () => {
    it("should set webhook URL", async () => {
      ...
      const result = await BotSettingsService.setWebhookUrl(
