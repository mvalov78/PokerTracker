...
const mockGetTournamentsByUser = getTournamentsByUser as jest.MockedFunction<
  typeof getTournamentsByUser
>;
const mockCalculateUserStats = calculateUserStats as jest.MockedFunction<
  typeof calculateUserStats
>;
...
describe("NotificationService", () => {
  ...
  describe("createTournamentReminder", () => {
    it("should create reminder with all details", () => {
      ...
      const message = service.createTournamentReminder(
        "Big Tournament",
        date,
        "Royal Casino",
      );
  ...
  describe("createAchievementNotification", () => {
    it("should create notification for known achievement", () => {
      const message = service.createAchievementNotification(
        "first_win",
        "Вы выиграли первый турнир!",
      );
  ...
  describe("createResultReminderNotification", () => {
    it("should create result reminder", () => {
      const message = service.createResultReminderNotification(
        "Weekly Tournament",
        3,
      );
  ...
  describe("createUpcomingTournamentsNotification", () => {
    it("should create notification with upcoming tournaments", () => {
      ...
      const message =
        service.createUpcomingTournamentsNotification(tournaments);
